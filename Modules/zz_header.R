customHeader <- dashboardHeader(tags$li(class = "dropdown",
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
    <th><h1 style="LINE-HEIGHT:5px; color: #dddddd; margin-bottom: -5px; font-size:45px;"><b>DatosNexION</b></h1></th></tr>
    <tr><th><h3 style="LINE-HEIGHT:0px; color: #dddddd; margin-top: 1px;">
    Soporte para el tratamiento de datos del instrumento <b>ICP-MS PerkinElmer NexION 300</b>
    </h3></th></tr>
    </table>')))
